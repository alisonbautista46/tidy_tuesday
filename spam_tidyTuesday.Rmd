...
spam_plot <- df %>%
  ...
  labs(title = "<span style='font-size:16pt'>you've got...</span>
       ...
       subtitle = "Occurrences of characters and words such as '000', 'money', 'make', '$', '!'that trigger\nspam filters,shown across 4,600 emails.",
  ...
  theme(aspect.ratio = 1/3,
        ...
        axis.text = element_text(color = 'grey', face = "bold", family = "PT Serif")
        )
